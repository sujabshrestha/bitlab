                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.subscriber') }}">Subscriber</a></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td>{{ $contact->created_at->format('Y, D m') }}</td>
                                    <td>
                                        <a href="{{ route('admin.subscriber.delete', $contact->id) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
